...
func checkOidcDeletedCookie(t *testing.T, rsp *http.Response, cookieName, expectedDomain string) {
	t.Helper()
...
func TestOidcLogoutNoRevokeTokenURL(t *testing.T) {
	...
	checkOidcDeletedCookie(t, rsp, config.TokenCookieName, applicationDomain)
